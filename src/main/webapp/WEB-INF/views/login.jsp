...
<link
	href="${pageContext.servletContext.contextPath}/resources/vendor/fontawesome-free/css/all.min.css"
...
<link
	href="${pageContext.servletContext.contextPath}/resources/css/sb-admin-2.min.css"
	rel="stylesheet">
...
<body class="bg-gradient-primary">
	...
	<script
		src="${pageContext.servletContext.contextPath}/resources/vendor/jquery-easing/jquery.easing.min.js"></script>

	<!-- Custom scripts for all pages-->
	<script
		src="${pageContext.servletContext.contextPath}/resources/js/sb-admin-2.min.js"></script>
